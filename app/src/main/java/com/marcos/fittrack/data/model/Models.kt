...
data class Workout(
    ...
    @SerializedName("elevation_gain_m") val elevationGainM: Int? = null,
    @SerializedName("swim_style") val swimStyle: String? = null,
    @SerializedName("pool_lengths") val poolLengths: Int? = null,
    @SerializedName("pool_length_m") val poolLengthM: Double? = null,
    val swolf: Int? = null,
